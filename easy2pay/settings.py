"""
Django settings for easy2pay project.
...
SECRET_KEY = 'django-insecure--bo$)(5v8hvp_bj=3in7!vj-rf-f-f6bh@j+#hu32!c54wmp8+'
...
MIDDLEWARE = [
    ...
    'ourapp.middleware.LoginRequiredMiddleware',
]

ROOT_URLCONF = 'easy2pay.urls'
...
WSGI_APPLICATION = 'easy2pay.wsgi.application'
